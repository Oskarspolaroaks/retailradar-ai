import { BarChart3, Package, AlertCircle, Calculator, Settings, LogOut, Music, Zap, CalendarDays, Radar } from "lucide-react";
...
const menuItems = [
  ...
  { title: "Price Optimization", url: "/smart-price", icon: Zap },
